...
local function loadSounds()
  ...
  musicTrack = audio.loadStream("Sounds/sfx_stream.mp3")
  audio.play(musicTrack)
  audio.setVolume( 0.1, { channel=musicTrack } )
end
...
local function setupImages()
  ...
  scoreTitle = display.newText(board, score, 80, -18, "Assets/Bureau Agency FB Bold.otf", 21)
  scoreTitle:setFillColor( 0.75, 0, 0 )
  bestTitle = display.newText(board, bestScore, 80, 24, "Assets/Bureau Agency FB Bold.otf", 21)
  ...
  local txt = {
    ...
    text="",
    font="Assets/Bureau Agency FB Bold.otf",
    fontSize=35 }
